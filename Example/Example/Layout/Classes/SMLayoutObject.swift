...
final class SMLayoutObject {
    ...
    private init(aspect: CGFloat, dimension: SMLayoutDimension, direction: SMLayoutDirection, sections: [SMLayoutObjectSection], source: SMLayoutSource, visible: SMLayoutVisible?) {
        self.aspect = aspect
    ...
    init(aspect: CGFloat, dimension: SMLayoutDimension, direction: SMLayoutDirection, source: SMLayoutSource, visible: SMLayoutVisible?) {
        self.aspect = aspect
        self.dimension = dimension
        self.direction = direction
        self.sections = {
